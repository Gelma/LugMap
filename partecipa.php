...
<div class="center_frame">
	<div class="textual">
		<p>
			Questa LugMap è frutto di un lavoro collettivo e collaborativo, cui tutti
			sono invitati a partecipare con suggerimenti e segnalazioni.
		</p>
		<p>
			Il sito viene periodicamente aggiornato sulla base di un
			<a href="https://github.com/Gelma/LugMap">repository GitHub</a>
			pubblicamente leggibile, in cui le informazioni sui LUG sono organizzate in
			<a href="http://github.com/Gelma/LugMap/blob/master/db/">file direttamente accessibili</a>,
			e comodamente fruibili da terzi alla stregua di file CSV.
		</p>
		<p>
