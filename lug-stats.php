...
function do_row ($nriga, $region, $tot, $perc) {
  ...
  <tr class="row_<?php echo ($nriga % 2); ?>">
    <td class="province"><a href="lug-list.php?reg=<?php echo $region; ?>"><?php echo $elenco_regioni [$region]; ?></a></td>
    <td><?php echo $tot; ?></td>
...
lugheader ('Statistiche sui Linux User Group italiani', 'statistiche');
