...
/usr/bin/find -type f | /bin/egrep '(.py|.html|.txt|.php)$' | /usr/bin/xargs /bin/grep -il 'Copyright 2010-2014' | /usr/bin/xargs /bin/sed -i 's/Copyright 2010-2014/Copyright 2010-2015/g'
