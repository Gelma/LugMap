...
/usr/bin/find -type f | /bin/egrep '(.py|.html|.txt|.php)$' | /usr/bin/xargs /bin/grep -il 'Copyright (C) 2010-2011' | /usr/bin/xargs /bin/sed -i 's/Copyright (C) 2010-2011/Copyright (C) 2010-2012/g'
