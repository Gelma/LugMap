...
<div id="footer">
  <table width="70%" align="center">
	<tr><td>
		<p class="helpMessage">
			Aiutaci a mantenere la LugMap aggiornata!
		...
		<p class="helpMessage">
			...
			<a class="generalink" href="http://github.com/Gelma/LugMap/raw/docs/Guida_Intergalattica_Alla_LugMap.pdf">Guida Intergalattica alla LugMap</a>.
		</p>
		<p class="helpMessage">
